...
/* harmony import */ var _utils_sticky_header__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/sticky-header */ "./js/utils/sticky-header.js");
...
/* harmony import */ var _utils_check_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/check-js */ "./js/utils/check-js.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_check_js__WEBPACK_IMPORTED_MODULE_7__["checkJs"])();
  ...
  window.addEventListener('load', function () {
    Object(_utils_check_js__WEBPACK_IMPORTED_MODULE_7__["addTransition"])();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_1__["initModals"])();
    Object(_modules_map_map__WEBPACK_IMPORTED_MODULE_6__["activateMapOnScroll"])();
    var burger = new _utils_burger__WEBPACK_IMPORTED_MODULE_4__["Burger"]();
    burger.init();
    var stickyHeader = new _utils_sticky_header__WEBPACK_IMPORTED_MODULE_5__["StickyHeader"]();
    stickyHeader.init();
...
/*!******************************!*\
  !*** ./js/utils/check-js.js ***!
  \******************************/
/*! exports provided: checkJs, addTransition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkJs", function() { return checkJs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addTransition", function() { return addTransition; });
var checkJs = function checkJs() {
  var jsList = document.querySelectorAll('.no-js');
  jsList.forEach(function (item) {
    item.classList.remove('no-js');
  });
};
var burgerMenu = document.querySelector('.main-nav--header');
